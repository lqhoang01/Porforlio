...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const cmdkCommands = [
    ...
    { label: 'Open Creative Portfolio', hint: 'Creative work', icon: 'spark', action: () => { window.location.href = 'creative.html'; } },
  ...
  const cmdkIcons = {
    ...
    spark: '<path d="M12 3l1.8 4.7L18.5 9.5l-4.7 1.8L12 16l-1.8-4.7-4.7-1.8 4.7-1.8L12 3z"></path><path d="M19 15l.8 2.2L22 18l-2.2.8L19 21l-.8-2.2L16 18l2.2-.8L19 15z"></path>',
  };
